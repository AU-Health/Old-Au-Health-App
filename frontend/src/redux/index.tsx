...
function getTruths(categoryName) {
  const url =
    'http://192.168.1.10:3000/dares-truths-questions/task/truth/' + categoryName
  ...
  fetch(url2, {
    ...
    headers: {
      ...
      Authorization:
        'Bearer ' +
        'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1dWlkIjoiNjgzOWVkMWYtYTRhZS0xMWViLWEzOWYtMjA0NzQ3ZDMyZjk3IiwiaXNBZG1pbiI6dHJ1ZSwiaXNWZXJpZmllZCI6MSwiY29uc2VudFNpZ25lZCI6MCwiaWF0IjoxNjE5NDYyMDY0LCJleHAiOjE2MTk0NzI4NjR9.1zK0TlRbtuKdUsyYwzp0SGqDqjPev0RP6SoWT12x6GM',
    },
  })
    .then((response) => response.json())
    .then((response) => {
