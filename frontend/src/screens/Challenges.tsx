    ...
    if (data[i].ActivityCompletedTypeName == 'Completed') {
      completedTasks.push(
        new TaskObj(
          data[i].CategoryName,
          data[i].Description,
          _selectTaskColor(data[i].CategoryName)
        )
      )
    } else {
...
function fetchTruths() {
  ...
  fetch(url, {
    ...
    headers: {
      ...
      Authorization:
        'Bearer ' +
        'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1dWlkIjoiNmI3OWZjYTgtOWY5OS0xMWViLWI1ODMtMjA0NzQ3ZDMyZjk3IiwiaXNBZG1pbiI6dHJ1ZSwiaXNWZXJpZmllZCI6MCwiY29uc2VudFNpZ25lZCI6MCwiaWF0IjoxNjE4OTQ5NTUwLCJleHAiOjE2MTg5NjAzNTB9.rpAxHT9pc8r1adBf4H-ygNE9mlE1-yWtStRroWn84-E',
    },
  })
    .then((responseJson) => {
