...
let items = [
  ...
  require('../assets/oa.png'),
  require('../assets/emotion.png'),
  require('../assets/social.png'),
  require('../assets/veg1.png'),
  require('../assets/slumb1.png'),
  require('../assets/water1.png'),
]

//temporary dictionary of truths for each category
let newl = '\n'
let tempTruths = {
  'How many minutes of moderate physical activity do adults need throughout the week?':
    ['25', '150', '75', '10'],
  'How many hours per week should the average college student spending working (studying and working)?':
    ['3', '6', '12', '40'],
  'True/false-Getting connected with others is not an important aspect of emotional wellness.':
    ['true', 'false'],
  'To have a robust sense of well-being, how many hours of social interaction should an adult have per day?':
    ['6', '1', '2', '10'],
  'How many cups per day of vegetables is part of a healthy eating pattern?': [
    '2 or 3',
    '4',
    '5 or 6',
    'less than 1',
  ],
  'How many hours of continual sleep does an average adult under the age of 65 need per night for optimal health?':
    ['5-7 hours', '7-8 hours', '9-10 hours', 'it doesn’t matter'],
  'How many cups of water should an adult have per day?': [
    '15.5',
    '11.3',
    '12',
    '19',
...
const extra = ['Fruit and Vegetable Consumption', 'Water Consumption']
...
class HomeScreen extends React.Component {
  ...
  handleAllThis = () => {
    if (this.props.truthsItems.payload) {
      console.log(
        'over hereeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee',
        this.props.truthsItems.payload.task.Description
      )
    }
  }
  render() {
      ...
      <SafeAreaView style={styles.container}>
        <View style={{ flex: 0.9 }}>
          <Image
            ...
            source={require('../assets/aucares.png')}
          />
        </View>
        <View
        ...
        >
          ...
          {this.state.winnerIndex != null && (
            <View>
              <Overlay
                overlayStyle={{ width: '70%', borderRadius: 7 }}
                  ...
                  >
                    {(() => {
                      ...
                      switch (this.state.winnerIndex) {
                        case 4:
                          return `Challenge: ${extra[0]}`
                        case 6:
                          return `Challenge: ${extra[1]}`
                        default:
                          return `Challenge: ${
                  ...
                  >
                    ...
                    <Button
                      ...
                      onPress={() => {
                        ...
                        this.props.fetchTruths(
                          backendParticipants[this.state.winnerIndex]
                        )
                        this.handleAllThis()
          ...
          {this.state.challengeOverlayVisible ? (
            <Overlay
              ...
              fullScreen={true}
              isVisible={this.state.challengeOverlayVisible}
              onBackdropPress={() => {
                this.setState({ challengeOverlayVisible: false })
              }}
            >
              <View style={{ flex: 1, flexDirection: 'column' }}>
                <View style={{ flex: 2 }}>
                    ...
                    {(() => {
                      switch (this.state.winnerIndex) {
                        ...
                        case 6:
                          return ` ${extra[1]}`
                        default:
                          return ` ${participants[this.state.winnerIndex]}`
                      }
                    })()}
                    !
                  </Text>
                  <ButtonGroup
                    onPress={(num) => {
                      this.setState({ selectedIndex: parseInt(num) })
                    }}
                ...
                >
                  {(() => {
                    switch (this.state.selectedIndex) {
                      ...
                      case 0:
                        return this.props.truthsItems.payload
                          ? this.props.truthsItems.payload.task.Description
                          : `${
                              Object.keys(tempTruths)[this.state.winnerIndex]
                            } \n \n`
                      case 1:
                        return `${tempDares[this.state.winnerIndex]}`
                      case 2:
                        return `Is there a way around a challenge your facing right now that involves doing more of the challenge: ${
                          participants[this.state.winnerIndex]
                        }?`
                      default:
                        return (
                          <Image
                            ...
                            source={items[this.state.winnerIndex]}
                          />
                        )
                    }
                  })()}
