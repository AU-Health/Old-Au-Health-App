...
export default class WheelOfWellness extends React.Component {
	state = {
	}

	spinWheel = () =>{
		console.log('you clicked the button now');
	}

	render() {
		return (
			<View style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }}>
				<Text style={{ fontSize: 20 }}><b>Wheel of Wellness</b></Text>

				

				<Button style={{radius: 2}}
					onPress={this.spinWheel}
					title="Spin Wheel"
					color="#d7263d"
					accessibilityLabel="Spin the wheel to select challenge"
